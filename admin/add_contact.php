...
if (isset($_POST["submit"])) {
  ...
  $contact_membid = $_POST['contact_memid'];
  $contact_desc = $_POST['contact_desc'];
  $contact_email = $_POST['contact_email'];
  $contact_phone = $_POST['contact_phone'];
   

   $sql = "INSERT INTO `contact`(`contact_id`, `contact_name`, `contact_memid`, `contact_desc`,'contact_email','contact_phone') VALUES (NULL,'$contact_name','$contact_memid','$contact_desc','$contact_email','$contact_phone')";
...
<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: yellow;">
       Contacts Form of Enhypen Official Club 
   </nav>
         ...
         <form action="" method="post" style="width:50vw; min-width:500px;">
            <div class="row mb-3">
               ...
               <div class="col">
                  ...
                  <input type="text" class="form-control" name="contact_memid" placeholder="202XXXXXX">
               </div>
