...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<a href="admin/index.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-black"><i class="fa fa-user fa-fw w3-margin-right"></i>ADMINISTRATOR</a> 
  </div>
...
<!-- Header -->
  <header id="membership">	
	<p align="center"><h3>Member of Enhypen Official Club</h3></p>
	<p>
	<p>
	<p>
...
<body>
	...
	<p align="center"><h3>Activities of Enhypen Official Club</h3></p>
...
<p>
  ...
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5 w3-text-white" style="background-color: #000000" >
    ...
    <p align ="center"><h4>Enhypen Official Club Achievements</h4></p>
    <!-- Pricing Tables -->
	<p>
  <p>
  <p>
...
<div class="w3-container w3-padding-64 w3-center" id="contact">
  ...
  <div class="container">
	...
	<p align="center"><h4>Contact of Enhypen Official Club</h4></p>
